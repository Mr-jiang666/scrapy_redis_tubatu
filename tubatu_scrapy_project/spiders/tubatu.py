    ...
    def parse(self, response):
        ...
        for item in pic_item_list:
            ...
            if item.xpath("./div/a/text()"):
                ...
                info['content_ajax_url'] = 'https://xiaoguotu.to8to.com/case/list?a2=0&a12=&a11={0}&a1=0&a17=1'.format(str(info['content_id']))
                # 我们使用yield来发送这个异步请求
